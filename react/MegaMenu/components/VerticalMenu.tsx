                ...
                <div className={classNames(handles.styledLinkContent, 'flex justify-between')}>
                  <div className={classNames(handles.styledLinkText, 'flex items-center')}>
                    <img
                      ...
                      alt=""
                    />
                    <span className={handles.styledLinkTextLabel}>Cont</span>
                  </div>
                  <div
                  ...
                  <div className={classNames(handles.styledLinkContent, 'flex justify-between')}>
                    <div className={classNames(handles.styledLinkText, 'flex items-center')}>
                      <img
                        ...
                        alt=""
                      />
                      <span className={handles.styledLinkTextLabel}>Produse</span>
                    </div>
                    <div
                ...
                <div className={classNames(handles.styledLinkContent, 'flex justify-between w-100')}>
                  <div className={classNames(handles.styledLinkText, 'flex items-center')}>
                    <img
                      ...
                      alt=""
                    />
                    <span className={handles.styledLinkTextLabel}>Promotii</span>
                  </div>
                </div>
              </a>
            </div>
                ...
                <div className={classNames(handles.styledLinkContent, 'flex justify-between w-100')}>
                  <div className={classNames(handles.styledLinkText, 'flex items-center')}>
                    <img
                      ...
                      alt=""
                    />
                    <span className={handles.styledLinkTextLabel}>Catalog</span>
                  </div>
                </div>
              </a>
            </div>
